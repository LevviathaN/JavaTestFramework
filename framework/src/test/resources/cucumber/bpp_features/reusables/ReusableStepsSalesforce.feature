...
Feature: Salesforce
  ...
  Scenario: Validate All Registry Cases Types
    ...
    Then I should see the "I have a question about my assessments feedback" "Salesforce cases dropdown option"
    Then I should see the "I have a question about my exam arrangements" "Salesforce cases dropdown option"
    Then I should see the "I have a question about my exam learning support" "Salesforce cases dropdown option"
    Then I should see the "I have a question about my results" "Salesforce cases dropdown option"
    Then I should see the "I have a Turnitin issue" "Salesforce cases dropdown option"
    Then I should see the "I would like a copy of my transcript" "Salesforce cases dropdown option"
    Then I should see the "I would like to defer my assessment or request an extension" "Salesforce cases dropdown option"
    Then I should see the "I would like to discuss appeals" "Salesforce cases dropdown option"
    Then I should see the "I would like to discuss assessment exemptions" "Salesforce cases dropdown option"
    Then I should see the "I would like to resit my exam" "Salesforce cases dropdown option"
    ...
    And I click on the "Query Type" "Salesforce cases dropdown field"
    And I click on the "Academic Progress" "Salesforce cases dropdown option"
    And I click on the "Query Subtype" "Salesforce cases dropdown field"
    Then I should see the "Personalised Study Plan" "Salesforce cases dropdown option"
    Then I should see the "Resit / Retake / Resubmission" "Salesforce cases dropdown option"
    And I click on the "Query Type" "Salesforce cases dropdown field"
    ...
    Then I should see the "My name is missing from the class register" "Salesforce cases dropdown option"
    Then I should see the "I have a query about my attendance record" "Salesforce cases dropdown option"
    Then I should see the "I need to inform you about my absence" "Salesforce cases dropdown option"
    ...
    And I click on the "Query Type" "Salesforce cases dropdown field"
    And I click on the "Change of programme, mode or location" "Salesforce cases dropdown option"
    And I click on the "Query Subtype" "Salesforce cases dropdown field"
    Then I should see the "Change of Programme" "Salesforce cases dropdown option"
    Then I should see the "Mode or Location" "Salesforce cases dropdown option"
    Then I should see the "Withdrawal" "Salesforce cases dropdown option"
    And I click on the "Query Type" "Salesforce cases dropdown field"
    And I click on the "Changes to studies or personal details" "Salesforce cases dropdown option"
    And I click on the "Query Subtype" "Salesforce cases dropdown field"
    Then I should see the "How do I collect my ID card?" "Salesforce cases dropdown option"
    Then I should see the "I have a question about my locker key" "Salesforce cases dropdown option"
    Then I should see the "I have a question about my Oyster card" "Salesforce cases dropdown option"
    Then I should see the "I need to change my personal details" "Salesforce cases dropdown option"
    Then I should see the "I want to change my programme, mode or location" "Salesforce cases dropdown option"
    Then I should see the "My ID card has been lost or stolen" "Salesforce cases dropdown option"
    And I click on the "Query Type" "Salesforce cases dropdown field"
    ...
    Then I should see the "I have a question about my graduation ceremony" "Salesforce cases dropdown option"
    Then I should see the "I have not received my certificate" "Salesforce cases dropdown option"
    Then I should see the "I need a replacement certificate" "Salesforce cases dropdown option"
    Then I should see the "I need my professional body certificate" "Salesforce cases dropdown option"
    Then I should see the "I would like my highest module mark certificate" "Salesforce cases dropdown option"
    ...
    And I click on the "Query Type" "Salesforce cases dropdown field"
    And I click on the "Hub" "Salesforce cases dropdown option"
    And I click on the "Query Subtype" "Salesforce cases dropdown field"
    Then I should see the "Activity Completion" "Salesforce cases dropdown option"
    Then I should see the "Module Missing" "Salesforce cases dropdown option"
    Then I should see the "Webinar recordings" "Salesforce cases dropdown option"
    And I click on the "Query Type" "Salesforce cases dropdown field"
    And I click on the "ID Card" "Salesforce cases dropdown option"
    And I click on the "Query Subtype" "Salesforce cases dropdown field"
    ...
    Then I should see the "I am on Interruption of Studies and wish to extend" "Salesforce cases dropdown option"
    Then I should see the "I would like to apply for Interruption of Studies" "Salesforce cases dropdown option"
    And I click on the "Query Type" "Salesforce cases dropdown field"
    ...
    Then I should see the "I would like a Council Tax letter" "Salesforce cases dropdown option"
    Then I should see the "I would like a GBC confirmation letter" "Salesforce cases dropdown option"
    Then I should see the "I would like a holiday letter" "Salesforce cases dropdown option"
    Then I should see the "I would like an academic reference" "Salesforce cases dropdown option"
    Then I should see the "My letter details are Incorrect" "Salesforce cases dropdown option"
    And I click on the "Query Type" "Salesforce cases dropdown field"
    ...
    And I click on the "Query Subtype" "Salesforce cases dropdown field"
    Then I should see the "I cannot see a submission link on Hub/VLE" "Salesforce cases dropdown option"
    Then I should see the "I have a group number Issue" "Salesforce cases dropdown option"
    Then I should see the "I have an issue with my online materials" "Salesforce cases dropdown option"
    Then I should see the "I have missing or wrong modules on Hub/VLE" "Salesforce cases dropdown option"
    Then I should see the "I need help accessing my webinar recordings" "Salesforce cases dropdown option"
    Then I should see the "Missing or wrong modules" "Salesforce cases dropdown option"
    And I click on the "Query Type" "Salesforce cases dropdown field"
    And I click on the "Online Learning Environment" "Salesforce cases dropdown option"
    And I click on the "Query Subtype" "Salesforce cases dropdown field"
    Then I should see the "I cannot see a submission link on Hub/VLE" "Salesforce cases dropdown option"
    Then I should see the "I have a group number Issue" "Salesforce cases dropdown option"
    Then I should see the "I have an issue with my timetable" "Salesforce cases dropdown option"
    Then I should see the "I have a question about my term dates" "Salesforce cases dropdown option"
    Then I should see the "I have missing or wrong modules on Hub/VLE" "Salesforce cases dropdown option"
    And I click on the "Query Type" "Salesforce cases dropdown field"
    ...
    And I click on the "Query Subtype" "Salesforce cases dropdown field"
    Then I should see the "I would like advice on organising my workload" "Salesforce cases dropdown option"
    Then I should see the "I would like help with study skills" "Salesforce cases dropdown option"
    Then I should see the "I would like support with other academic skills" "Salesforce cases dropdown option"
    Then I should see the "I would like to book a Personal Tutor appointment" "Salesforce cases dropdown option"
    And I click on the "Query Type" "Salesforce cases dropdown field"
    ...
    Then I should see the "How do I collect my ID card?" "Salesforce cases dropdown option"
    Then I should see the "I am an international student with a registration query" "Salesforce cases dropdown option"
    Then I should see the "I have an exemptions question" "Salesforce cases dropdown option"
    Then I should see the "I have a question about my Oyster card" "Salesforce cases dropdown option"
    Then I should see the "I missed my induction, how do I catch up?" "Salesforce cases dropdown option"
    And I click on the "Query Type" "Salesforce cases dropdown field"
    And I click on the "Student finance and loans" "Salesforce cases dropdown option"
    And I click on the "Query Subtype" "Salesforce cases dropdown field"
    Then I should see the "Can I have a copy of my payment plan?" "Salesforce cases dropdown option"
    Then I should see the "How can I pay my fees?" "Salesforce cases dropdown option"
    Then I should see the "I am in financial difficulty, what are my options?" "Salesforce cases dropdown option"
    Then I should see the "I am taking an interruption of studies, how does that affect my payment plan and fees?" "Salesforce cases dropdown option"
    Then I should see the "I have a question about my student loan" "Salesforce cases dropdown option"
    Then I should see the "I have been billed for resit assessments, can I check what these are?" "Salesforce cases dropdown option"
    Then I should see the "I would like a receipt for my most recent transaction" "Salesforce cases dropdown option"
    Then I should see the "I would like the Student Finance Team to call me about a query I have" "Salesforce cases dropdown option"
    Then I should see the "I would like to dispute the balance on my account" "Salesforce cases dropdown option"
    Then I should see the "I would like to provide feedback on my recent experience" "Salesforce cases dropdown option"
    Then I should see the "SPP Request" "Salesforce cases dropdown option"
    Then I should see the "Suspension Warning" "Salesforce cases dropdown option"
    Then I should see the "When is my next instalment due?" "Salesforce cases dropdown option"
    Then I should see the "When will I receive my refund?" "Salesforce cases dropdown option"
    And I click on the "Query Type" "Salesforce cases dropdown field"
    And I click on the "Study Skills" "Salesforce cases dropdown option"
    And I click on the "Query Subtype" "Salesforce cases dropdown field"
    Then I should see the "Any Other Academic Skills" "Salesforce cases dropdown option"
    Then I should see the "Employability / Presentations" "Salesforce cases dropdown option"
    Then I should see the "Excel / Data Analysis / Maths" "Salesforce cases dropdown option"
    Then I should see the "Referencing/Academic Writing" "Salesforce cases dropdown option"
    And I click on the "Query Type" "Salesforce cases dropdown field"
    And I click on the "Visa" "Salesforce cases dropdown option"
    And I click on the "Query Subtype" "Salesforce cases dropdown field"
    Then I should see the "I have a question about my Visa" "Salesforce cases dropdown option"
    Then I should see the "I need to report a problem with my Biometric Resident Permit" "Salesforce cases dropdown option"
    Then I should see the "I want to apply for a Shengen/travel Visa" "Salesforce cases dropdown option"
    Then I should see the "I would like to apply for an extension of my Visa" "Salesforce cases dropdown option"
    Then I should see the "I would like to book an appointment for Visa advice" "Salesforce cases dropdown option"
    And I click on the "Query Type" "Salesforce cases dropdown field"
    And I click on the "Timetables" "Salesforce cases dropdown option"
    And I click on the "Query Subtype" "Salesforce cases dropdown field"
    Then I should see the "I have an issue with my timetable" "Salesforce cases dropdown option"
    Then I should see the "I have a question about my term dates" "Salesforce cases dropdown option"
    Then I click on the "I have a question about my term dates" "Salesforce cases dropdown option"
    And I click on the "Study Location" "Salesforce cases dropdown field"
    Then I click on the "Birmingham" "Salesforce cases dropdown option"
    And I click on the "School" "Salesforce cases dropdown field"
    Then I click on the "Nursing" "Salesforce cases dropdown option"
    And I click on the "Save" "Product Factory button title"
    And I wait for "3" seconds
