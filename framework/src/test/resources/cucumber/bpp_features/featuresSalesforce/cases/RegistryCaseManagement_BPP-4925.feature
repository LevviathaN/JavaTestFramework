...
Feature: Registry Case Management
  ...
  @AssignmentRules
  Scenario: Registry Case Management Verify Case Assignment Attendance
    Given I execute "Log In To Salesforce" reusable step
  ...
  @AssignmentRules
  Scenario: Registry Case Management Verify Case Assignment Rules Lockers_Oyster_Timetable_Complaint
    Given I execute "Log In To Salesforce" reusable step
    #Letter Production
    And I execute "Create Assesments Registry Case" reusable step replacing some steps
      | 9  | I click on the "Letter requests" "Salesforce cases dropdown option"   |
      | 11 | I click on the "Acceptance" "Salesforce cases dropdown option" |
    And I should scroll to the "top" of the page
    #And I validate text "CONTAINS=Academic Admin" to be displayed for "Salesforce Case Owner Data Field" element
    #Locker Key
    And I execute "Create Assesments Registry Case" reusable step replacing some steps
      | 9  | I click on the "Lockers" "Salesforce cases dropdown option"       |
