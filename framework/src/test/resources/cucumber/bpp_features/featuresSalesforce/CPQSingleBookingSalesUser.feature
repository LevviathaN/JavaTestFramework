...
Feature: Create a Single Booking
  ...
  Scenario: CPQ Single Booking Sales User
    Given I execute "Log In To Salesforce" reusable step replacing some steps
      |2|I fill the "Salesforce Username" field with "MD_COMMON_CREDENTIALS_SALESFORCESALES"|
      |3|I fill the "Salesforce Password" field with "MD_COMMON_CREDENTIALS_SALESFORCESALESPASSWORD"|
    ...
    Then I execute "Add A Booking Sales User" reusable step
    Given I am on "MD_COMMON_LINKS_SALESFORCEINSTANCE" URL
    And Browser performs "REFRESH" command
