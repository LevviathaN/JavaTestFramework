...
Feature: Ability for Course / Paper etc to be published from Product Factory into BPP.com / The Hub and viewable as an Admin within The Hub
  ...
  Scenario: Verify the Published Course is Successfully Transferred From PF to the BPP Website
    ...
    And I validate text "CONTAINS=EC_ECOMMERCE_NAME" to be displayed for "1" "BPP Digital Syllabus from Product Factory"
    ...
    And I validate text "CONTAINS=EC_ECOMMERCE_NAME" to be displayed for "2" "BPP Digital Syllabus from Product Factory"
    ...
    And I validate text "CONTAINS=EC_ECOMMERCE_NAME" to be displayed for "3" "BPP Digital Syllabus from Product Factory"
