...
Feature: Product Factory API Data Creation
  ...
  Scenario: Audit Trail - Low Fidelity logging of Material Type record changes
    ...
    And I verify that "EC_TIME_NOW_ONE" element "contains" to "EC_MATERIAL_TYPE_CREATED_ON" element
    ...
    And I verify that "EC_TIME_NOW_TWO" element "contains" to "EC_MATERIAL_TYPE_UPDATED_ON" element
