...
Feature: Product Factory API Data Creation
  ...
  Scenario: Audit Trail - Low Fidelity logging of Class Category record changes
    Given I execute "Create Class Category" API step
    And I verify that "[TIMENOW-OHB-yyyy-MM-dd'T'HH:mm]" element "contains" to "EC_CLASS_CATEGORY_CREATED_ON" element
    ...
    And I verify that "~Second[TIMENOW-OHB-yyyy-MM-dd'T'HH:mm]" element "contains" to "EC_CLASS_CATEGORY_UPDATED_ON" element
