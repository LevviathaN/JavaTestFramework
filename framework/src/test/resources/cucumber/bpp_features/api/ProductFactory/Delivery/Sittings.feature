...
Feature: Product Factory API Data Creation
  ...
  Scenario: Audit Trail - Low Fidelity logging of Sitting record changes
    ...
    And I verify that "EC_TIME_NOW_ONE" element "contains" to "EC_SITTING_CREATED_ON" element
    ...
    And I verify that "EC_TIME_NOW_TWO" element "contains" to "EC_SITTING_UPDATED_ON" element
