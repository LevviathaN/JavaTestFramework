...
Feature: Product Factory API Data Creation
  ...
  Scenario: Audit Trail - Low Fidelity logging of Study Mode record changes
    ...
    And I verify that "EC_TIME_NOW_ONE" element "contains" to "EC_STUDY_MODE_CREATED_ON" element
    ...
    And I verify that "EC_TIME_NOW_TWO" element "contains" to "EC_STUDY_MODE_UPDATED_ON" element
