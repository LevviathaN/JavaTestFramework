...
Feature: Product Factory API Data Creation
  ...
  Scenario: Audit Trail - Low Fidelity logging of Deactivation Reason record changes
    Given I execute "Create Deactivation Reason" API step
    And I verify that "[TIMENOW-yyyy-MM-dd'T'HH:mm]" element "contains" to "EC_DEACTIVATION_REASON_CREATED_ON" element
    ...
    And I verify that "~Second[TIMENOW-yyyy-MM-dd'T'HH:mm]" element "contains" to "EC_UPDATE_DEACTIVATION_REASON_CREATED_ON" element
