...
Feature: Product Factory API Data Creation
  ...
  Scenario: Audit Trail - Low Fidelity logging of Vertical record changes
    ...
    And I verify that "EC_TIME_NOW_ONE" element "contains" to "EC_VERTICAL_CREATED_ON" element
    ...
    And I verify that "EC_TIME_NOW_TWO" element "contains" to "EC_VERTICAL_UPDATED_ON" element
