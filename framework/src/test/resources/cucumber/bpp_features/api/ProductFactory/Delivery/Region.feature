...
Feature: Product Factory API Data Creation
  ...
  Scenario: Audit Trail - Low Fidelity logging of Region record changes
    ...
    And I verify that "EC_TIME_NOW_ONE" element "contains" to "EC_REGION_CREATED_ON" element
    ...
    And I verify that "EC_TIME_NOW_TWO" element "contains" to "EC_UPDATE_REGION_UPDATED_ON" element
