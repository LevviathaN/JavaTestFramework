...
Feature: Filters Validation
  ...
  Scenario Outline: Ring Filters Validation <metal> <shape> <style>
    ...
    # apply filters
    And I click on the "Diamonds Listing Page Show Filters Button" element
    And I click on the "<metal>" "Rings Listing Page Filter Checkbox"
    And I wait for "2" seconds
    And I click on the "Diamonds Listing Page Show Filters Button" element
    And I click on the "<shape>" "Rings Listing Page Filter Checkbox"
    And I wait for "2" seconds
    And I click on the "Diamonds Listing Page Show Filters Button" element
    And I click on the "<style>" "Rings Listing Page Filter Checkbox"
...
#      |Browser performs "BACK" command                                                               |
  ...
  Scenario Outline: Diamond Filters Validation
    ...
    And I drag "Cut Grade" "Diamonds Listing Page Filter From Slider Point" to "<cutFrom>" "Diamonds Listing Page Filter Slider Marker"
    And I drag "Cut Grade" "Diamonds Listing Page Filter To Slider Point" to "<cutTo>" "Diamonds Listing Page Filter Slider Marker"
    ...
    And I capture text data "Cut" "Diamonds Details Page Attribute" as "EC_CUT" variable
