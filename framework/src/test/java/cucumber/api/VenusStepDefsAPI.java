...
public class VenusStepDefsAPI {
    ...
    public VenusStepDefsAPI i_register_new_hub_account() {
        ...
        Response accountResponse = restController.postRequestHub(propertiesHelper.getProperties().getProperty("hub_register_linkUAT"),
                String.valueOf(restController.processPropertiesHubRegistration("registerHubAccountUAT")));
        ...
        BPPLogManager.getLogger().info("Hub user is successfully registered via API request. User id is: " + userID);
